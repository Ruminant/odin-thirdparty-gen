...
AV_DICT_DEDUP           :: 128   /**< If inserting a value that already exists for a key, do nothing. Only relevant with AV_DICT_MULTIKEY. */
...
foreign lib {
	...
	*/
	av_dict_get :: proc(m: ^AVDictionary, key: cstring, prev: ^AVDictionaryEntry, flags: i32) -> ^AVDictionaryEntry ---
	...
	*/
	av_dict_iterate :: proc(m: ^AVDictionary, prev: ^AVDictionaryEntry) -> ^AVDictionaryEntry ---
	...
	*/
	av_dict_count :: proc(m: ^AVDictionary) -> i32 ---
	...
	*/
	av_dict_set :: proc(pm: ^^AVDictionary, key: cstring, value: cstring, flags: i32) -> i32 ---
	...
	*/
	av_dict_set_int :: proc(pm: ^^AVDictionary, key: cstring, value: i64, flags: i32) -> i32 ---
	...
	*/
	av_dict_parse_string :: proc(pm: ^^AVDictionary, str: cstring, key_val_sep: cstring, pairs_sep: cstring, flags: i32) -> i32 ---
	...
	*/
	av_dict_copy :: proc(dst: ^^AVDictionary, src: ^AVDictionary, flags: i32) -> i32 ---
	...
	*/
	av_dict_get_string :: proc(m: ^AVDictionary, buffer: ^cstring, key_val_sep: i8, pairs_sep: i8) -> i32 ---
}
