...
foreign lib {
	...
	*/
	avcodec_descriptor_get :: proc(id: AVCodecID) -> ^AVCodecDescriptor ---
	...
	*/
	avcodec_descriptor_next :: proc(prev: ^AVCodecDescriptor) -> ^AVCodecDescriptor ---

	/**
	* @return codec descriptor with the given name or NULL if no such descriptor
	*         exists.
	*/
	avcodec_descriptor_get_by_name :: proc(name: cstring) -> ^AVCodecDescriptor ---
}
