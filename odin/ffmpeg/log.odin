...
AVClass :: struct {
	...
	*/
	item_name: proc "c" (ctx: rawptr) -> cstring,
	...
	* ::category otherwise.
	*/
	get_category: proc "c" (ctx: rawptr) -> AVClassCategory,

	/**
	* Callback to return the supported/allowed ranges.
	*/
	query_ranges: proc "c" (_: ^^AVOptionRanges, obj: rawptr, key: cstring, flags: i32) -> i32,

	/**
	* Return next AVOptions-enabled child or NULL
	*/
	child_next: proc "c" (obj: rawptr, prev: rawptr) -> rawptr,
	...
	*/
	child_class_iterate: proc "c" (iter: ^rawptr) -> ^AVClass,
...
foreign lib {
	...
	*/
	av_log :: proc(avcl: rawptr, level: i32, fmt: cstring, #c_vararg _: ..any) ---
	...
	*/
	av_log_once :: proc(avcl: rawptr, initial_level: i32, subsequent_level: i32, state: ^i32, fmt: cstring, #c_vararg _: ..any) ---
	...
	*/
	av_vlog :: proc(avcl: rawptr, level: i32, fmt: cstring, vl: c.va_list) ---
	...
	*/
	av_log_set_callback :: proc(callback: proc "c" (rawptr, i32, cstring, c.va_list)) ---
	...
	* @param vl The arguments referenced by the format string.
	*/
	av_log_default_callback :: proc(avcl: rawptr, level: i32, fmt: cstring, vl: c.va_list) ---
	...
	*/
	av_default_item_name    :: proc(ctx: rawptr) -> cstring ---
	av_default_get_category :: proc(ptr: rawptr) -> AVClassCategory ---
	...
	*/
	av_log_format_line :: proc(ptr: rawptr, level: i32, fmt: cstring, vl: c.va_list, line: cstring, line_size: i32, print_prefix: ^i32) ---
	...
	*/
	av_log_format_line2 :: proc(ptr: rawptr, level: i32, fmt: cstring, vl: c.va_list, line: cstring, line_size: i32, print_prefix: ^i32) -> i32 ---
}
...
@(default_calling_convention="c")
foreign lib {
	av_log_set_flags :: proc(arg: i32) ---
	av_log_get_flags :: proc() -> i32 ---
}
