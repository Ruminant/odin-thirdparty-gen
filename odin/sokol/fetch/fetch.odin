...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_GL {
            when DEBUG { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_dll_windows_x64_gl_debug.lib" } }
            else       { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_dll_windows_x64_gl_release.lib" } }
        } else {
            when DEBUG { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_dll_windows_x64_d3d11_debug.lib" } }
            else       { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_dll_windows_x64_d3d11_release.lib" } }
        }
    } else {
        when USE_GL {
            when DEBUG { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_fetch_windows_x64_gl_debug.lib" } }
            else       { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_fetch_windows_x64_gl_release.lib" } }
        } else {
            when DEBUG { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_fetch_windows_x64_d3d11_debug.lib" } }
            else       { foreign import sokol_fetch_clib { "../libs/windows/amd64/sokol_fetch_windows_x64_d3d11_release.lib" } }
        }
    }
} else when ODIN_OS == .Darwin {
    when USE_DLL {
             when  USE_GL && ODIN_ARCH == .arm64 &&  DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_gl_debug.dylib" } }
        else when  USE_GL && ODIN_ARCH == .arm64 && !DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_gl_release.dylib" } }
        else when  USE_GL && ODIN_ARCH == .amd64 &&  DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_gl_debug.dylib" } }
        else when  USE_GL && ODIN_ARCH == .amd64 && !DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_gl_release.dylib" } }
        else when !USE_GL && ODIN_ARCH == .arm64 &&  DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_metal_debug.dylib" } }
        else when !USE_GL && ODIN_ARCH == .arm64 && !DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_metal_release.dylib" } }
        else when !USE_GL && ODIN_ARCH == .amd64 &&  DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_metal_debug.dylib" } }
        else when !USE_GL && ODIN_ARCH == .amd64 && !DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_metal_release.dylib" } }
    } else {
        when USE_GL {
            when ODIN_ARCH == .arm64 {
                when DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_fetch_macos_arm64_gl_debug.a" } }
                else       { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_fetch_macos_arm64_gl_release.a" } }
            } else {
                when DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_fetch_macos_x64_gl_debug.a" } }
                else       { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_fetch_macos_x64_gl_release.a" } }
            }
        } else {
            when ODIN_ARCH == .arm64 {
                when DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_fetch_macos_arm64_metal_debug.a" } }
                else       { foreign import sokol_fetch_clib { "../libs/darwin/arm64/sokol_fetch_macos_arm64_metal_release.a" } }
            } else {
                when DEBUG { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_fetch_macos_x64_metal_debug.a" } }
                else       { foreign import sokol_fetch_clib { "../libs/darwin/amd64/sokol_fetch_macos_x64_metal_release.a" } }
            }
        }
    }
} else when ODIN_OS == .Linux {
    when USE_DLL {
        when DEBUG { foreign import sokol_fetch_clib { "../libs/linux/amd64/sokol_fetch_linux_x64_gl_debug.so", "system:pthread" } }
        else       { foreign import sokol_fetch_clib { "../libs/linux/amd64/sokol_fetch_linux_x64_gl_release.so", "system:pthread" } }
    } else {
        when DEBUG { foreign import sokol_fetch_clib { "../libs/linux/amd64/sokol_fetch_linux_x64_gl_debug.a", "system:pthread" } }
        else       { foreign import sokol_fetch_clib { "../libs/linux/amd64/sokol_fetch_linux_x64_gl_release.a", "system:pthread" } }
    }
} else when ODIN_ARCH == .wasm32 || ODIN_ARCH == .wasm64p32 {
    // Feed sokol_fetch_wasm_gl_debug.a or sokol_fetch_wasm_gl_release.a into emscripten compiler.
    foreign import sokol_fetch_clib { "env.o" }
} else {
...
foreign sokol_fetch_clib {
    ...
    // "continue" is a reserved word in Odin
    // continue :: proc(h: Handle) ---    
    
}

// special case for the continue() function, because "continue" is a reserved word in Odin
@(default_calling_convention="c")
foreign sokol_fetch_clib {
    @(link_name="sfetch_continue")
    continue_request :: proc(h: Handle) ---
}
