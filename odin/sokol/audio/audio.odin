...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_GL {
            when DEBUG { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_dll_windows_x64_gl_debug.lib" } }
            else       { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_dll_windows_x64_gl_release.lib" } }
        } else {
            when DEBUG { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_dll_windows_x64_d3d11_debug.lib" } }
            else       { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_dll_windows_x64_d3d11_release.lib" } }
        }
    } else {
        when USE_GL {
            when DEBUG { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_audio_windows_x64_gl_debug.lib" } }
            else       { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_audio_windows_x64_gl_release.lib" } }
        } else {
            when DEBUG { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_audio_windows_x64_d3d11_debug.lib" } }
            else       { foreign import sokol_audio_clib { "../libs/windows/amd64/sokol_audio_windows_x64_d3d11_release.lib" } }
        }
    }
} else when ODIN_OS == .Darwin {
    when USE_DLL {
             when  USE_GL && ODIN_ARCH == .arm64 &&  DEBUG { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_gl_debug.dylib" } }
        else when  USE_GL && ODIN_ARCH == .arm64 && !DEBUG { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_gl_release.dylib" } }
        else when  USE_GL && ODIN_ARCH == .amd64 &&  DEBUG { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_gl_debug.dylib" } }
        else when  USE_GL && ODIN_ARCH == .amd64 && !DEBUG { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_gl_release.dylib" } }
        else when !USE_GL && ODIN_ARCH == .arm64 &&  DEBUG { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_metal_debug.dylib" } }
        else when !USE_GL && ODIN_ARCH == .arm64 && !DEBUG { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_metal_release.dylib" } }
        else when !USE_GL && ODIN_ARCH == .amd64 &&  DEBUG { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_metal_debug.dylib" } }
        else when !USE_GL && ODIN_ARCH == .amd64 && !DEBUG { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_metal_release.dylib" } }
    } else {
        when USE_GL {
            when ODIN_ARCH == .arm64 {
                when DEBUG { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_audio_macos_arm64_gl_debug.a", "system:AudioToolbox.framework" } }
                else       { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_audio_macos_arm64_gl_release.a", "system:AudioToolbox.framework" } }
            } else {
                when DEBUG { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_audio_macos_x64_gl_debug.a", "system:AudioToolbox.framework" } }
                else       { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_audio_macos_x64_gl_release.a", "system:AudioToolbox.framework" } }
            }
        } else {
            when ODIN_ARCH == .arm64 {
                when DEBUG { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_audio_macos_arm64_metal_debug.a", "system:AudioToolbox.framework" } }
                else       { foreign import sokol_audio_clib { "../libs/darwin/arm64/sokol_audio_macos_arm64_metal_release.a", "system:AudioToolbox.framework" } }
            } else {
                when DEBUG { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_audio_macos_x64_metal_debug.a", "system:AudioToolbox.framework" } }
                else       { foreign import sokol_audio_clib { "../libs/darwin/amd64/sokol_audio_macos_x64_metal_release.a", "system:AudioToolbox.framework" } }
            }
        }
    }
} else when ODIN_OS == .Linux {
    when USE_DLL {
        when DEBUG { foreign import sokol_audio_clib { "../libs/linux/amd64/sokol_audio_linux_x64_gl_debug.so", "system:dl", "system:pthread" } }
        else       { foreign import sokol_audio_clib { "../libs/linux/amd64/sokol_audio_linux_x64_gl_release.so", "system:dl", "system:pthread" } }
    } else {
        when DEBUG { foreign import sokol_audio_clib { "../libs/linux/amd64/sokol_audio_linux_x64_gl_debug.a", "system:asound", "system:dl", "system:pthread" } }
        else       { foreign import sokol_audio_clib { "../libs/linux/amd64/sokol_audio_linux_x64_gl_release.a", "system:asound", "system:dl", "system:pthread" } }
    }
