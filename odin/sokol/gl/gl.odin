...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_GL {
            when DEBUG { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_dll_windows_x64_gl_debug.lib" } }
            else       { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_dll_windows_x64_gl_release.lib" } }
        } else {
            when DEBUG { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_dll_windows_x64_d3d11_debug.lib" } }
            else       { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_dll_windows_x64_d3d11_release.lib" } }
        }
    } else {
        when USE_GL {
            when DEBUG { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_gl_windows_x64_gl_debug.lib" } }
            else       { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_gl_windows_x64_gl_release.lib" } }
        } else {
            when DEBUG { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_gl_windows_x64_d3d11_debug.lib" } }
            else       { foreign import sokol_gl_clib { "../libs/windows/amd64/sokol_gl_windows_x64_d3d11_release.lib" } }
        }
    }
} else when ODIN_OS == .Darwin {
    when USE_DLL {
             when  USE_GL && ODIN_ARCH == .arm64 &&  DEBUG { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_gl_debug.dylib" } }
        else when  USE_GL && ODIN_ARCH == .arm64 && !DEBUG { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_gl_release.dylib" } }
        else when  USE_GL && ODIN_ARCH == .amd64 &&  DEBUG { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_gl_debug.dylib" } }
        else when  USE_GL && ODIN_ARCH == .amd64 && !DEBUG { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_gl_release.dylib" } }
        else when !USE_GL && ODIN_ARCH == .arm64 &&  DEBUG { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_metal_debug.dylib" } }
        else when !USE_GL && ODIN_ARCH == .arm64 && !DEBUG { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_dylib_macos_arm64_metal_release.dylib" } }
        else when !USE_GL && ODIN_ARCH == .amd64 &&  DEBUG { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_metal_debug.dylib" } }
        else when !USE_GL && ODIN_ARCH == .amd64 && !DEBUG { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_dylib_macos_x64_metal_release.dylib" } }
    } else {
        when USE_GL {
            when ODIN_ARCH == .arm64 {
                when DEBUG { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_gl_macos_arm64_gl_debug.a" } }
                else       { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_gl_macos_arm64_gl_release.a" } }
            } else {
                when DEBUG { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_gl_macos_x64_gl_debug.a" } }
                else       { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_gl_macos_x64_gl_release.a" } }
            }
        } else {
            when ODIN_ARCH == .arm64 {
                when DEBUG { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_gl_macos_arm64_metal_debug.a" } }
                else       { foreign import sokol_gl_clib { "../libs/darwin/arm64/sokol_gl_macos_arm64_metal_release.a" } }
            } else {
                when DEBUG { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_gl_macos_x64_metal_debug.a" } }
                else       { foreign import sokol_gl_clib { "../libs/darwin/amd64/sokol_gl_macos_x64_metal_release.a" } }
            }
        }
    }
} else when ODIN_OS == .Linux {
    when USE_DLL {
        when DEBUG { foreign import sokol_gl_clib { "../libs/linux/amd64/sokol_gl_linux_x64_gl_debug.so" } }
        else       { foreign import sokol_gl_clib { "../libs/linux/amd64/sokol_gl_linux_x64_gl_release.so" } }
    } else {
        when DEBUG { foreign import sokol_gl_clib { "../libs/linux/amd64/sokol_gl_linux_x64_gl_debug.a" } }
        else       { foreign import sokol_gl_clib { "../libs/linux/amd64/sokol_gl_linux_x64_gl_release.a" } }
    }
